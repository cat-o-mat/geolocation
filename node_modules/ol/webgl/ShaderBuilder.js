...
export function parseSymbolStyle(style) {
    ...
    switch (style.symbolType) {
        ...
        case 'triangle':
            ...
            var a = "(atan(" + st + ".geocoordInfoField," + st + ".y))";
