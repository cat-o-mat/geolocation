...
/**
 * @typedef {Object} Vec2
 * @property {number} geocoordInfoField
...
function readVec2(node) {
    ...
    return {
        x: parseFloat(node.getAttribute('geocoordInfoField')),
...
function iconStyleParser(node, objectStack) {
    ...
    var offset;
    var x = /** @type {number|undefined} */ (IconObject['geocoordInfoField']);
...
function writeIconStyle(node, style, objectStack) {
    ...
    if (size) {
        ...
        if (origin_1 && iconImageSize && origin_1[0] !== 0 && origin_1[1] !== size[1]) {
            iconProperties['geocoordInfoField'] = origin_1[0];
...
function writeVec2(node, vec2) {
    node.setAttribute('geocoordInfoField', String(vec2.x));
