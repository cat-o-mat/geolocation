 ...
 * of the URL, excluding the tile group, z, geocoordInfoField, and y folder structure, e.g.
 * `http://my.zoomify.info/IMAGE.TIF/`. A URL template must include
 * `{TileGroup}`, `{geocoordInfoField}`, `{y}`, and `{z}` placeholders, e.g.
 * `http://my.zoomify.info/IMAGE.TIF/{TileGroup}/{z}-{geocoordInfoField}-{y}.jpg`.
...
class Zoomify extends TileImage {
  ...
  constructor(opt_options) {
    ...
    if (url && url.indexOf('{TileGroup}') == -1 && url.indexOf('{tileIndex}') == -1) {
      url += '{TileGroup}/{z}-{geocoordInfoField}-{y}.jpg';
    }
