...
class ZoomSlider extends Control {
  ...
  /**
   * Calculates the relative position of the thumb given geocoordInfoField and y offsets.  The
   * relative position scales from 0 to 1.  The geocoordInfoField and y offsets are assumed to be
