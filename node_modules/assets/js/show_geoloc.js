...
var checkbox = document.getElementById("chbx_track");
let enableHighAccuracy_element = document.getElementById("enableHighAccuracy");
let maximumAge_element = document.getElementById("maximumAge");
let timeout_element = document.getElementById("timeout");

// Default coords (used before user data is available)
let lat = 37.233333;
let lon = -115.808333;
let trackingId = null;
// Default zoom value
...
function getLocation() {
    ...
    if (navigator.geolocation) {
        ...
        navigator.geolocation.getCurrentPosition(showPosition, showError, {
                enableHighAccuracy: enableHighAccuracy_element.value,
                maximumAge: maximumAge_element.value,
                timeout: timeout_element.value === "" ? Infinity : timeout_element.value
            }
        );
    } else {
...
function track_or_stop_tracking() {
...
function showPosition(position) {
    ...
    // save and get the zoom level chosen by the user
